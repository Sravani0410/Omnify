    ...
    const serviceFetchData = async () => {
      try {
        const res = await axios.get(
          `https://backend-data-nine.vercel.app/services`
        );
      ...
      {filterbycategory === "name" ? (
        <div>
          ...
          {searchResult.length > 0 && (
            <div>
              <h4>
                Showing {searchResult.length} results matching &quot;
                {serviceName}&quot;:
              </h4>
              {searchResult.map((el) => (
                <div
        ...
        <div className="flex flex-col">
          ...
          <div>
            <h4>
              Showing {filteredTagsResult.length} results matching &quot;type=
              {searchbytag.type} and status ={searchbytag.status}&quot;:
            </h4>
